...
export default function HeroSection() {
  return (
    <section id="hero" className="flex flex-col md:flex-row items-center justify-between w-full min-h-[calc(100vh-80px)] pt-16 md:pt-28 pb-8 md:pb-12 px-4 md:px-16 bg-transparent relative z-20">
      <RobotImage />
      <HeroContent />
    </section>
  );
